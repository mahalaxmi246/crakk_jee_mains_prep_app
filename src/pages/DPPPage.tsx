...
import { ArrowLeft, BookOpen, Target, TrendingUp, ArrowRight } from 'lucide-react';
    ...
    mathematics: {
      ...
      topics: [
        { 
          ...
          chapters: 8, 
          progress: 75,
          description: 'Linear equations, quadratic equations, sequences & series',
          totalProblems: 120
        },
        { 
          name: 'Calculus', 
          chapters: 6, 
          progress: 60,
          description: 'Differential calculus, integral calculus, limits',
          totalProblems: 95
        },
        { 
        ...
        { 
          ...
          chapters: 3, 
          progress: 45,
          description: 'Vectors, 3D coordinates, planes, lines',
          totalProblems: 55
        },
        { 
          ...
          chapters: 4, 
          progress: 70,
          description: 'Probability, permutations, combinations, statistics',
          totalProblems: 70
        }
      ]
    },
    physics: {
      ...
      topics: [
        { 
          ...
          chapters: 7, 
          progress: 80,
          description: 'Kinematics, dynamics, work-energy, rotational motion',
          totalProblems: 110
        },
        { 
          name: 'Thermodynamics', 
        ...
        { 
          ...
          chapters: 8, 
          progress: 55,
          description: 'Electric field, magnetic field, electromagnetic induction',
          totalProblems: 125
        },
        { 
          name: 'Modern Physics', 
          chapters: 6, 
          progress: 40,
          description: 'Atomic structure, nuclear physics, quantum mechanics',
          totalProblems: 85
        },
        { 
          ...
          chapters: 3, 
          progress: 85,
          description: 'Simple harmonic motion, wave motion, sound waves',
          totalProblems: 50
        }
      ]
    },
    chemistry: {
      ...
      topics: [
        ...
        { 
          ...
          chapters: 10, 
          progress: 70,
          description: 'Periodic table, coordination compounds, metallurgy',
          totalProblems: 130
        },
        { 
        ...
        { 
          ...
          chapters: 2, 
          progress: 90,
          description: 'Environmental pollution, green chemistry',
          totalProblems: 25
        },
        { 
          ...
          chapters: 3, 
          progress: 80,
          description: 'Drugs, polymers, biomolecules',
          totalProblems: 40
        }
      ]
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 text-center shadow-sm border border-gray-100">
            <div className="text-3xl font-bold text-purple-600 mb-2">{currentSubject.topics.length}</div>
            <div className="text-gray-600">Topics Available</div>
          </div>
          <div className="bg-white rounded-xl p-6 text-center shadow-sm border border-gray-100">
            <div className="text-3xl font-bold text-blue-600 mb-2">
              {currentSubject.topics.reduce((sum: number, topic: any) => sum + topic.chapters, 0)}
            </div>
            <div className="text-gray-600">Total Chapters</div>
          </div>
          <div className="bg-white rounded-xl p-6 text-center shadow-sm border border-gray-100">
            <div className="text-3xl font-bold text-green-600 mb-2">
              {currentSubject.topics.reduce((sum: number, topic: any) => sum + topic.totalProblems, 0)}
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          {currentSubject.topics.map((topic: any, index: number) => (
            <Link
              key={index}
              to={`/dpp/${subject}/${topic.name.toLowerCase().replace(/\s+/g, '-').replace(/&/g, 'and')}`}
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">
                    {topic.progress >= 80 ? 'Excellent' : 
                     topic.progress >= 60 ? 'Good Progress' : 'Needs Practice'}
                  </span>
                </div>
